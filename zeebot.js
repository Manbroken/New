...
//Database RPG Mode By Zee!! Ori No
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        //+++ || FAKE TROLI         
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `𝗭𝗘𝗘𝗦𝗘𝗟𝗙𝗕𝗢𝗧`, orderTitle: 'LordPebri&Zee', sellerJid: '0@s.whatsapp.net'} } }    
...
//»»»𝘉𝘶𝘵𝘵𝘰𝘯 𝘉𝘢𝘮𝘩 
    ...
    case 'group': case 'gc': case 'grup':     	 
          ...
          sendButton(from, menu, 'Created By Zee', but, troli)
          break           
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET:zeebotz22@gmail.com\n` +
            `item2.X-ABLabel:📧 Email\n` +
            `item3.URL:wa.me/12722261451\n` +
            ...
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator Zee`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
